"""Auth Service — SQLAlchemy models with KYC Verification integration."""
...
class User(Base):
    ...
    # KYC Fields
    kyc_status: Mapped[str] = mapped_column(String(20), nullable=False, default="unverified")  # unverified, pending, verified, rejected
    kyc_id_type: Mapped[str | None] = mapped_column(String(50), nullable=True)  # NIN, BVN, Kenyan_ID, Fayda_ID, Passport
    ...
    kyc_records: Mapped[list[KycVerification]] = relationship(back_populates="user", cascade="all, delete-orphan")
...
class KycVerification(Base):
    """Afroid KYC — Python Mobile App verification session & audit record."""
    ...
    status: Mapped[str] = mapped_column(String(30), nullable=False, default="pending_scan")  # pending_scan, scanned, doc_captured, liveness_passed, verified, rejected
    ...
    audit_hash: Mapped[str | None] = mapped_column(String(64), nullable=True)  # SHA-256 cryptographic audit chain proof
    ...
    user: Mapped[Optional[User]] = relationship(back_populates="kyc_records")
