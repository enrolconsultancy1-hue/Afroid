...
## 🚀 How to Load & Configure in Google Chrome
...
2. **⚡ Zero-Question Architect Quick-Intake**:
   ...
   - Enter any startup idea and click **"Formulate Blueprint in IDE"** to immediately open the Web IDE and trigger parallel sub-agent workers.

3. **🛡️ RegTech Compliance Audit**:
   - Select any African jurisdiction (Nigeria, Kenya, Ethiopia, AU) to run an instant regulatory check against national startup acts.

4. **🖱️ Right-Click "Send to geezcodE IDE"**:
   - Highlight any text or code snippet on any webpage, right-click, and select **"Send to geezcodE IDE"**.
